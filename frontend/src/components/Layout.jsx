...
const ADMIN_NAV = [
  ...
  { to: '/admin/sold-devices', label: 'Devices Sold', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /> },
...
const PAGE_TITLES = {
  ...
  '/admin/sold-devices':     'Devices Sold',
