    ...
    <div className="pb-24 lg:pb-6 min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50">
      ...
      <div className="bg-white rounded-2xl shadow-card p-5 mb-4">
        ...
        <div className="hidden lg:flex flex-col items-center mb-4">
          <div
            className="w-24 h-24 rounded-full overflow-hidden border-4 border-emerald-200 cursor-pointer"
            onClick={() => photoUrl && setViewingPhoto(photoUrl)}
          >
            {photoUrl ? (
              <img src={photoUrl} alt="Profile" className="w-full h-full object-cover" />
        ...
        <div className="bg-emerald-50 rounded-2xl p-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-xl font-black text-emerald-800 tracking-wider">{acct || 'N/A'}</p>
          </div>
          <button
            onClick={copyAccountNumber}
            className={`flex items-center gap-1.5 px-4 py-2.5 rounded-xl font-semibold text-sm transition-all
              ${copied ? 'bg-green-600 text-white' : 'bg-emerald-700 text-white hover:bg-green-900 active:scale-95'}`}
          >
            {copied ? (
              <>
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="bg-white rounded-2xl shadow-card p-5 mb-4">
        ...
        <a
          ...
          className="flex items-center gap-4 py-3 px-4 bg-emerald-50 rounded-2xl hover:bg-emerald-100 transition-colors"
        >
          ...
          <div>
            <p className="text-sm font-semibold text-emerald-800">Call Tritech Hub iOS</p>
        ...
        <a
          ...
          className="flex items-center gap-4 py-3 px-4 bg-emerald-50 rounded-2xl hover:bg-emerald-100 transition-colors mt-2"
        >
          <div className="w-10 h-10 rounded-full bg-emerald-200 flex items-center justify-center">
