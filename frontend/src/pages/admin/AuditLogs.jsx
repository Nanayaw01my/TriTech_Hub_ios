...
const ACTION_COLORS = {
  ...
  staff_added: 'text-blue-600 bg-blue-50',
  staff_updated: 'text-blue-600 bg-blue-50',
  staff_deleted: 'text-red-600 bg-red-50',
  device_added: 'text-purple-600 bg-purple-50',
